    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-sm">
          This area is restricted to Distributor administrators only.
        </p>
...
// ─── Main Component ───────────────────────────────────────────────────────────
export function DistributorAdminSettings() {
  const { userProfile, companyProfile, canManageForgeAIAlerts } = useApp();
  const [activeTab, setActiveTab] = useState<DistributorAdminTab>("profile");

  const isDistributorOrg = companyProfile?.companyType === "Distributor";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Manage your distributor workspace, users, notifications, and ForgeAI
            alerts
          </p>
        </div>
        <span
      ...
      <div className="fade-in">
        ...
        {activeTab === "forgeai" && (
          <div className="mt-6">
            <AIProviderSettings wsType="distributor" />
          </div>
        )}
        {activeTab === "users" && (
