import { bm as PartnerTier, j as jsxRuntimeExports } from "./index-DvFvlUBj.js";
const TIER_STYLES = {
  [PartnerTier.Silver]: {
    background: "linear-gradient(135deg, #A8A9AD 0%, #C4C5C9 50%, #A8A9AD 100%)",
    color: "#1a1a1a",
    border: "rgba(196,197,201,0.4)",
    label: "Silver"
  },
  [PartnerTier.Gold]: {
    background: "linear-gradient(135deg, #C9A227 0%, #F0CC5A 50%, #C9A227 100%)",
    color: "#1a1a0a",
    border: "rgba(240,204,90,0.4)",
    label: "Gold"
  },
  [PartnerTier.Platinum]: {
    background: "linear-gradient(135deg, #4A4A4F 0%, #6B6B70 40%, #5a5a60 70%, #4A4A4F 100%)",
    color: "#f0f0f2",
    border: "rgba(107,107,112,0.5)",
    shimmer: "after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-white/10 after:to-transparent after:rounded-full",
    label: "Platinum"
  }
};
const SIZE_CLASSES = {
...
function TierBadge({
  ...
  const styles = TIER_STYLES[tier] ?? TIER_STYLES[PartnerTier.Silver];
