...
const SAMPLE_USERS = [
  {
    id: "u1",
    name: "Sarah Holloway",
    email: "sarah.holloway@ingrammicro.com",
    role: "Primary Admin",
    status: "Active",
    lastLogin: "2026-05-09T10:22:00Z"
  },
  {
    id: "u2",
    name: "James Tan",
    ...
    status: "Active",
    lastLogin: "2026-05-08T14:55:00Z"
  },
  {
    id: "u3",
    ...
    role: "Sales User",
    status: "Active",
    lastLogin: "2026-05-07T09:10:00Z"
  },
  {
    id: "u4",
    name: "Marcus Webb",
    email: "marcus.webb@ingrammicro.com",
    role: "Sales User",
    status: "Pending",
    lastLogin: "—"
  }
...
const SAMPLE_AUDIT = [
  {
    ...
    user: "Sarah Holloway",
    timestamp: "2026-05-09T10:24:00Z",
    detail: "Renewal alert threshold changed from 30 to 45 days"
  },
  {
    id: "a2",
    action: "User invited",
    ...
    detail: "Invited marcus.webb@ingrammicro.com as Sales User"
  },
  {
    id: "a3",
    ...
    detail: "Pipeline health alerts enabled for Primary Admin"
  },
  {
    id: "a4",
    ...
    detail: "MFA set to required for all admin roles"
  }
];
function AccessDenied() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "distributor_admin.access_denied",
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-sm", children: "This area is restricted to Distributor administrators only." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            "data-ocid": "distributor_admin.access_denied.back_button",
...
function ProfileTab() {
  ...
  const [form, setForm] = reactExports.useState({
    ...
    contactEmail: "admin@ingrammicro.com",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "distributor_admin.profile.panel",
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                "data-ocid": "distributor_admin.profile.logo_upload_button",
                children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "flex flex-col gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: "crm-input",
                  "data-ocid": "distributor_admin.profile.org_name.input"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: "crm-input",
                  "data-ocid": "distributor_admin.profile.region.input"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: "crm-input",
                  "data-ocid": "distributor_admin.profile.contact_email.input"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: "crm-input",
                  "data-ocid": "distributor_admin.profile.contact_phone.input"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: "crm-input",
                  "data-ocid": "distributor_admin.profile.website.input"
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": "distributor_admin.profile.save_button",
...
function NotificationRulesTab({ isPrimaryAdmin }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "data-ocid": "distributor_admin.notifications.panel",
...
function ForgeAIAlertsTab({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      className: "flex flex-col gap-4",
      "data-ocid": "distributor_admin.forgeai.panel",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ForgeAIAlertConfig,
        {
          companyType: "Distributor",
...
function UserManagementTab({ isPrimaryAdmin }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      className: "flex flex-col gap-4",
      "data-ocid": "distributor_admin.users.panel",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": "distributor_admin.users.invite_button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "crm-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-thin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: SAMPLE_USERS.map((u, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              "data-ocid": `distributor_admin.users.item.${i + 1}`,
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    "data-ocid": `distributor_admin.users.edit_button.${i + 1}`,
                    children: "Edit"
                  }
                ) })
              ]
...
function SecurityAuthTab() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      className: "flex flex-col gap-4",
      "data-ocid": "distributor_admin.security.panel",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: [
        ...
        },
        {
          ...
          value: "Required for Admin roles",
          status: "Active"
        },
        {
        ...
        },
        {
          ...
          value: "Okta / Azure AD / SAML (placeholder)",
          status: "Pending"
        }
        ...
        "div",
        {
          ...
          "data-ocid": `distributor_admin.security.${item.title.toLowerCase().replace(/\s+/g, "_")}.card`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `status-badge text-[10px] font-semibold ${item.status === "Active" ? "bg-emerald-500/15 text-emerald-400 border border-emerald-500/20" : item.status === "Configured" ? "bg-blue-500/15 text-blue-400 border border-blue-500/20" : "bg-yellow-500/15 text-yellow-400 border border-yellow-500/20"}`,
...
function AuditLogTab() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      className: "flex flex-col gap-4",
      "data-ocid": "distributor_admin.audit.panel",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "crm-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-thin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: SAMPLE_AUDIT.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            className: "border-b border-border/40 hover:bg-secondary/10 transition-colors",
            "data-ocid": `distributor_admin.audit.item.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TriangleAlert,
...
function AppearanceTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "distributor_admin.appearance.panel",
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              "data-ocid": "distributor_admin.appearance.dark_mode.toggle",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              "data-ocid": "distributor_admin.appearance.light_mode.toggle",
...
function DistributorAdminSettings() {
  const { userProfile, companyProfile, canManageForgeAIAlerts } = useApp();
  const [activeTab, setActiveTab] = reactExports.useState("profile");
  const isDistributorOrg = (companyProfile == null ? void 0 : companyProfile.companyType) === "Distributor";
  const isPrimaryAdmin = (userProfile == null ? void 0 : userProfile.isPrimaryAdmin) === true;
  const isSecondaryAdmin = (userProfile == null ? void 0 : userProfile.role) === UserRole.DistributorSecondaryAdmin;
  const hasAccess = isDistributorOrg && (isPrimaryAdmin || isSecondaryAdmin);
  if (!hasAccess) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "distributor_admin.page",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold font-display text-foreground", children: "Distributor Admin Settings" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage your distributor workspace, users, notifications, and ForgeAI alerts" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: "Distributor Workspace"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-ocid": "distributor_admin.tabs",
            children: TABS.map((tab) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  "data-ocid": `distributor_admin.${tab.id}.tab`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in", children: [
          ...
          activeTab === "forgeai" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AIProviderSettings, { wsType: "distributor" }) }),
