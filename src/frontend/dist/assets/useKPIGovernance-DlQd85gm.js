import { r as reactExports } from "./index-DvFvlUBj.js";
...
const DEFAULT_KPI_DEFINITIONS = [
  {
    ...
    category: "Revenue",
    description: "Total value of subscription and contract renewals closed within the period against target.",
  ...
  },
  {
    ...
    name: "AI Adoption",
    category: "Adoption",
    description: "Percentage of active partner accounts with at least one AI-enabled workflow activated.",
  ...
  },
  {
    ...
    category: "Pipeline",
    description: "YoY percentage growth in qualified pipeline value across the operational territory.",
    formulaType: "growth_rate",
    formulaExpression: "((currentPipeline - priorYearPipeline) / priorYearPipeline) * 100",
    weight: 15,
    benchmarkTarget: 25,
    benchmarkUnit: "%",
    warningThreshold: 8,
  ...
  },
  {
    ...
    name: "MDF ROI",
    category: "Marketing",
    description: "Return on Market Development Funds — revenue attributed per £1 of MDF invested.",
    formulaType: "ratio",
  ...
  },
  {
    ...
    description: "Accuracy of quarterly revenue forecasts against final actuals — reflects operational predictability.",
    formulaType: "percentage",
    formulaExpression: "100 - abs((forecastedRevenue - actualRevenue) / actualRevenue * 100)",
    weight: 12,
    benchmarkTarget: 90,
    benchmarkUnit: "%",
    warningThreshold: 5,
  ...
  },
  {
    ...
    category: "Pipeline",
    description: "Average number of days from opportunity creation to Closed Won. Lower is better.",
    formulaType: "average",
  ...
  },
  {
    ...
    category: "Growth",
    description: "YoY revenue growth generated through the reseller partner tier.",
    formulaType: "growth_rate",
    formulaExpression: "((currentResellerRevenue - priorYearResellerRevenue) / priorYearResellerRevenue) * 100",
    weight: 7,
    benchmarkTarget: 18,
    benchmarkUnit: "%",
    warningThreshold: 8,
  ...
  },
  {
    ...
    category: "Growth",
    description: "Percentage of contracted Distributors with at least one closed transaction in the current period.",
    formulaType: "percentage",
  ...
  },
  {
    ...
    category: "Revenue",
    description: "Total upsell and cross-sell revenue from existing customer accounts within the period.",
    formulaType: "attainment",
  ...
  },
  {
    ...
    category: "Pipeline",
    description: "Percentage of submitted quotes that convert to Closed Won opportunities within 90 days.",
    formulaType: "percentage",
...
const DEFAULT_AUDIT_ENTRIES = [
  ...
  },
  {
    ...
    previousValue: "10%",
    newValue: "15%",
    notes: "Weight increased following quarterly review — pipeline now a strategic priority."
  },
  {
    id: "audit-004",
    kpiId: "kpi-mdf-roi",
    ...
    notes: "Formula updated to reflect attributed revenue model vs gross revenue."
  },
  {
    id: "audit-005",
    kpiId: "kpi-forecast-accuracy",
    ...
    notes: "Benchmark raised following operational review — 90% now the governance standard."
  },
  {
    id: "audit-006",
    kpiId: "kpi-opportunity-velocity",
  ...
  },
  {
    ...
    notes: "Tightened warning threshold — early detection of activation gaps is operationally critical."
  },
  {
    id: "audit-009",
    kpiId: "kpi-customer-expansion",
  ...
  },
  {
    ...
    notes: "Quote Conversion KPI introduced to link pricing workflow to revenue outcomes."
  },
  {
    id: "audit-011",
    kpiId: "kpi-ai-adoption",
    ...
    notes: "Adoption benchmark raised following strong H2 2024 performance across Vendor tier."
  },
  {
    id: "audit-012",
    kpiId: "kpi-mdf-roi",
  ...
  },
  {
    ...
    notes: "Critical threshold tightened to give earlier warning of underperformance in growth KPIs."
  },
  {
    id: "audit-014",
    kpiId: "kpi-renewal-revenue",
    ...
    previousValue: "25%",
    newValue: "30%",
    notes: "Renewal Revenue weight increased to 30% — board directive for FY2025."
  },
  {
    id: "audit-015",
    kpiId: "kpi-reseller-growth",
    ...
    notes: "Territory weighting adjusted following Q4 underperformance in Nordics reseller tier."
  },
  {
    id: "audit-016",
    kpiId: "kpi-distributor-activation",
    ...
    notes: "Activation target raised following DACH success — global benchmark now 80%."
  },
  {
    id: "audit-017",
    kpiId: "kpi-forecast-accuracy",
    ...
    notes: "Visibility extended — forecast accuracy now shared with Sales Ops and Finance for governance alignment."
  },
  {
    id: "audit-018",
    kpiId: "kpi-opportunity-velocity",
    ...
    notes: "Formula clarified to use closedWonDate only — excludes lost opportunities from velocity calculation."
  },
  {
    id: "audit-019",
    kpiId: "kpi-customer-expansion",
    ...
    previousValue: "5%",
    newValue: "3%",
    notes: "Weight reduced — expansion KPI re-scoped to enterprise tier only for Q2 2025."
  },
  {
    id: "audit-020",
    kpiId: "kpi-quote-conversion",
    ...
    notes: "Benchmark raised following DACH pilot results — 38% is now the operational standard."
  }
];
const DEFAULT_FORGE_INSIGHTS = [
  {
    id: "fi-001",
    type: "territory_trend",
    kpiId: "kpi-pipeline-growth",
    kpiName: "Pipeline Growth",
    message: "Nordics trending below YoY expectation for Pipeline Growth. Current trajectory suggests an 8% shortfall against Q1 2025 target.",
    territory: "Nordics",
    severity: "warning",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-renewal-revenue",
    kpiName: "Renewal Revenue",
    message: "Renewal Revenue improving month-over-month in UK&I territories. Current attainment at 99.3% of target — on track to exceed Q1 benchmark.",
    territory: "UK&I",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-ai-adoption",
    kpiName: "AI Adoption",
    message: "AI Adoption stabilizing across reseller group after Q4 2024 dip. DACH and UK&I showing consistent upward movement — Southern Europe remains the primary gap.",
    severity: "info",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-opportunity-velocity",
    kpiName: "Opportunity Velocity",
    message: "Deal registration conversion slowing in Tier 1 territories — Opportunity Velocity metric flagged. Southern Europe averaging 55 days vs 42-day benchmark.",
    territory: "Southern Europe",
    severity: "warning",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-forecast-accuracy",
    kpiName: "Forecast Accuracy",
    message: "Forecast Accuracy improving across the reseller group — now at 91.2% vs 88.4% last quarter. Consistent with improved pipeline qualification discipline.",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-mdf-roi",
    kpiName: "MDF ROI",
    message: "MDF ROI variance detected in Nordics — currently tracking at 2.8x vs 3.5x benchmark. YoY variance of -23.7% suggests a structural change in campaign attribution.",
    territory: "Nordics",
    severity: "warning",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-distributor-activation",
    kpiName: "Distributor Activation",
    message: "Distributor Activation accelerating in DACH and Benelux — ahead of YoY targets. DACH at 84.3% activated vs 80% benchmark; Benelux at 82.1%.",
    territory: "DACH",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-pipeline-growth",
    kpiName: "Pipeline Growth",
    message: "Pipeline Growth on track nationally; Southern Europe showing below-benchmark progression at 11.3% vs 25% target. Intervention recommended before end of Q2.",
    territory: "Southern Europe",
    severity: "warning",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-reseller-growth",
    kpiName: "Reseller Growth",
    message: "Reseller Growth momentum improving in UK&I after territory realignment. Q1 2025 performance at 16.8% vs 18% target — closing the gap from Q4 2024.",
    territory: "UK&I",
    severity: "info",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-customer-expansion",
    kpiName: "Customer Expansion",
    message: "Customer Expansion rate exceeding YoY expectation across enterprise tier. UK&I and DACH both delivering above benchmark — expansion pipeline remains healthy.",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-reseller-growth",
    kpiName: "Reseller Growth",
    message: "Reseller Growth in Southern Europe showing continued underperformance — 11.4% against an 18% target. Three consecutive quarters below benchmark.",
    territory: "Southern Europe",
    severity: "critical",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-renewal-revenue",
    kpiName: "Renewal Revenue",
    message: "Renewal performance stabilizing across distributed reseller tier. Forecasts for Q2 2025 suggest continued improvement — risk concentrated in Nordics distributor segment.",
    severity: "info",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-distributor-activation",
    kpiName: "Distributor Activation",
    message: "Distributor Activation remains critically low in Southern Europe at 58.6% — 21.4 percentage points below the 80% global benchmark. Root cause analysis recommended.",
    territory: "Southern Europe",
    severity: "critical",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-opportunity-velocity",
    kpiName: "Opportunity Velocity",
    message: "Opportunity Velocity improving beyond expectations in UK&I — average deal cycle now 37.6 days, beating the 42-day benchmark and improving 24.8% YoY.",
    territory: "UK&I",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-mdf-roi",
    kpiName: "MDF ROI",
    message: "MDF ROI outperforming in DACH — 3.9x return against 3.5x benchmark. Campaign attribution model showing strong results from Q1 partner engagement programs.",
    territory: "DACH",
    severity: "positive",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-ai-adoption",
    kpiName: "AI Adoption",
    message: "AI Adoption in Southern Europe continues to lag — at 42.5% vs 65% target. Reseller enablement gap identified as likely driver. Recommended action: targeted AI onboarding campaign.",
    territory: "Southern Europe",
    severity: "critical",
    period: "2025-Q1",
  ...
  },
  {
    ...
    kpiId: "kpi-quote-conversion",
    kpiName: "Quote Conversion",
    message: "Quote Conversion momentum improving in DACH — 41.4% conversion rate exceeds the 38% benchmark. Pricing strategy alignment showing positive commercial outcomes.",
    territory: "DACH",
    severity: "positive",
    period: "2025-Q1",
...
function trendFromVariance(variance) {
  if (variance > 2) return "up";
  if (variance < -2) return "down";
  return "stable";
}
function useKPIGovernance() {
  const [kpiDefinitions, setKpiDefinitions] = reactExports.useState(() => {
    try {
      const stored = localStorage.getItem(LS_DEFS);
      return stored ? JSON.parse(stored) : DEFAULT_KPI_DEFINITIONS;
    } catch {
      return DEFAULT_KPI_DEFINITIONS;
    }
  });
  const [kpiDataPoints] = reactExports.useState(() => {
    try {
  ...
  const [kpiAuditLog, setKpiAuditLog] = reactExports.useState(() => {
    try {
  ...
  const [forgeInsights] = reactExports.useState(() => {
    try {
  ...
  const saveKPIDefinitions = reactExports.useCallback((defs) => {
    setKpiDefinitions(defs);
  }, []);
  const addAuditEntry = reactExports.useCallback(
    (kpiId, kpiName, changeType, changedBy) => {
      const entry = {
  ...
  const getKPIsByRole = reactExports.useCallback(
    (role) => {
  ...
  const getKPIDataPoints = reactExports.useCallback(
    (kpiId) => {
      return kpiDataPoints.filter((p) => p.kpiId === kpiId);
    },
    [kpiDataPoints]
  );
  const getLatestDataPoint = reactExports.useCallback(
    (kpiId) => {
      const points = kpiDataPoints.filter((p) => p.kpiId === kpiId).sort((a, b) => b.period.localeCompare(a.period));
      return points[0];
    },
    [kpiDataPoints]
  );
  const computeScorecard = reactExports.useCallback(
    (period, role) => {
      const roleKPIs = getKPIsByRole(role);
      const entries = roleKPIs.map((kpi) => {
        const dp = kpiDataPoints.filter((p) => p.kpiId === kpi.id && p.period === period).sort(
          (a, b) => (a.territory ?? "").localeCompare(b.territory ?? "")
        )[0];
        const status = (dp == null ? void 0 : dp.status) ?? "on_track";
        const rawScore = scoreForStatus(status);
        const weighted = rawScore * kpi.weight / 100;
        const variance = (dp == null ? void 0 : dp.yoyVariance) ?? 0;
        return {
          kpiId: kpi.id,
          kpiName: kpi.name,
          weight: kpi.weight,
      ...
      const rawTotal = totalWeight > 0 ? entries.reduce(
        (sum, e) => sum + e.score / (e.weight / 100 || 1) * (e.weight / totalWeight),
        0
      ) : 0;
      return {
  ...
  const getForgeInsights = reactExports.useCallback(() => {
    return forgeInsights.slice().sort(
      (a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
    );
  }, [forgeInsights]);
  const territories = Array.from(
    new Set(
      kpiDataPoints.map((p) => p.territory).filter((t) => Boolean(t))
    )
  );
  return {
    kpiDefinitions,
